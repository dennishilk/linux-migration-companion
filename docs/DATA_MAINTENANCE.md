...
The distro and software catalogs are curated evidence snapshots, not scraped live feeds.

## Source standard

Use the strongest available primary source:

1. official vendor/project system requirements or download page;
2. official support/documentation page;
3. official project repository or release notes.

Community compatibility databases can be offered as a manual research aid, but they must not be converted into an official-support claim or hard compatibility promise.
...
- Plain DE/EN summary distinguishing official and community routes.
- Representative verification task (files, plug-ins, policies, devices, titles, anti-cheat, saves, formats).
- Direct primary HTTPS source and review date.

## Distribution record checklist
